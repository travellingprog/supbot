...
// TODO
//  - Do BAD test for polling with just some wait
//  - Do a mock of the Gitter API
//  - Make each streaming API request output to a msgs channel
//  - Make my Initialize take a done channel
//  - Make a test for Initialize
